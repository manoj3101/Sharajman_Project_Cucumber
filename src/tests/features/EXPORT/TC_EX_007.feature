Feature: TC_EX_007
  ...
  Scenario: Discom Member Create CFP and Publishing the CFP.
    Given Admin navigate to the application and login and fetching the transaction fee formula as per export case seven
  ...
  Scenario: Discom Member Genarating Format D as initiator
    Given User navigate to the Application and logged in as a discom user as initiator as per export case Seven
    Then Format D should be successfully Generated from initiator side as per export case Seven

  Scenario: Discom Member Genarating Format D as Responder
    Given User navigate to the Application and logged in as a discom user as Responder as per export case Seven
    Then Format D should be successfully Generated from Responder side as per export case Seven
