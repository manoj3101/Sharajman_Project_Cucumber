...
#     Given User navigate to the Application and logged in as a discom user as initiator as per export case eight
#     And User started generating Format D from initiator side  as per export case eight
#     Then Format D  should be successfully Generated as Expected as per export case eight
