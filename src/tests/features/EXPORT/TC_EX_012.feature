...
#     Then CFP should be Placed successfully as Expected from responder as per export case twelve

#   Scenario: Discom Member Awarding CFP and Generating LOA.
#     Given User navigate to the Application and logged in as a discom user as initiator as per export case twelve
#     Then CFP for Awarding time should be expired successfully as Expected from initiator as per export case twelve