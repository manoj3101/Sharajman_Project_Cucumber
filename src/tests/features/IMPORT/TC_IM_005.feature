...
#     Given User navigate to the Application and logged in as a discom user as initiator as per import case five
#     And User started generating Format D from initiator side as per import case five
#     Then Format D  should be successfully Generated as per import case five
