...
#     Given User navigate to the Application and logged in as a discom user as initiator as per import case three
#     And User started generating Format D from initiator side as per import case three
#     Then Format D  should be successfully Generated as per import case three
