...
Then('Admin approves the new discom user and assigns a subscription plan as per Admin case sixteen', async function () {
    ...
    await manage_Member.approve_Member(org_name, ad_data.AD_16.Manage_member);  //Member assitance
...
Then('Admin approves the payment and assigns rights to the new user as per Admin case sixteen', async function () {
    ...
    await payment_Approval.paymentApproval(org_name, ad_data.AD_16.Payment_approval);
