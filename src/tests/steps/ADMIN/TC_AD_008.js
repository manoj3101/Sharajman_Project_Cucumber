...
Then('Admin approves the payment and assigns rights to the new user as per Admin case eight', async function () {
    ...
    await manage_Member.member_rights(org_name, ad_data.AD_08.selectall, ad_data.AD_08.Home, ad_data.AD_08.Manage_User, ad_data.AD_08.FormatD, ad_data.AD_08.LOA_Generation, ad_data.AD_08.Award, ad_data.AD_08.Respond, ad_data.AD_08.LOA_Management);
...
//@                                                     Scenario 3
//-------------------------------------------------------------------------------------------------------------------------
Given('Admin navigate to the application and login and fetching the transaction fee formula as per admin case eight', async function () {

    await login.login(data.admin, data.admin_password);
    await transactionFee.click_Transaction_Fee(); //Click the transaction fee 
    await transactionFee.fetch_Transaction_Fee(data.feeName, ad_data.AD_08.Quantum_value); // Fetch the transaction fee formula
...
Given('New User started generating the award and generating the LOA from initiator side as per admin case eight', { timeout: 1200000 }, async function () {
...
Then('Awarding and Generate LOA should be successfull as per admin case eight', async function () {
    ...
    await dashboardCFP.generateLOA(cfpNumber, DashboardCFP.imp_start_date, DashboardCFP.imp_end_date, ad_data.AD_08.imp_start_time, ad_data.AD_08.imp_end_time, ad_data.AD_08.minQuantumValue1, DashboardCFP.exp_start_date, DashboardCFP.exp_end_date, ad_data.AD_08.exp_start_time, ad_data.AD_08.exp_end_time, ad_data.AD_08.ReturnValue1, ad_data.AD_08.Settlement_Price, ad_data.AD_08.loa_issuance_mins);
...
Then('Responder Uploading the documents should be successfull as per admin case eight', async function () {

    await loaManagement.loaGeneration();

    console.log("Global CFP: " + cfpNumber);

    await loaManagement.uploadDocument(cfpNumber, DashboardCFP.imp_start_date, DashboardCFP.imp_end_date, ad_data.AD_08.imp_start_time, ad_data.AD_08.imp_end_time, ad_data.AD_08.Quantum_value, DashboardCFP.exp_start_date, DashboardCFP.exp_end_date, ad_data.AD_08.exp_start_time, ad_data.AD_08.exp_end_time, ad_data.AD_08.ReturnValue1, ad_data.AD_08.Settlement_Price, ad_data.AD_08.loa_acceptance_mins);
...
Then('Format D should be successfully Generated from initiator side as per admin case eight', async function () {
    ...
    await loaManagement.formatD(ad_data.AD_08.GTAM, ad_data.AD_08.source_of_generation, ad_data.AD_08.RPO, ad_data.AD_08.TGNA, DashboardCFP.imp_start_date, DashboardCFP.imp_end_date, ad_data.AD_08.imp_start_time, ad_data.AD_08.imp_end_time, ad_data.AD_08.Quantum_value);
...
Then('Format D should be successfully Generated from Responder side as per admin case eight', async function () {
...
Given('New User started placing Response to the CFP as per admin case eight', { timeout: 120 * 1000 }, async function () {
...
Then('New User Response CFP should be Placed successfully as per admin case eight', async function () {
...
Given('User started generating the award and generating the LOA from initiator side as per admin case eight', { timeout: 1200000 }, async function () {
...
Then('User Awarding and Generate LOA should be successfull as per admin case eight', async function () {
...
Then('New User Responder Uploading the documents should be successfull as per admin case eight', async function () {
...
//@                                                     Scenario 13
//-------------------------------------------------------------------------------------------------------------------------
Then('User Format D should be successfully Generated from initiator side as per admin case eight', async function () {
...
Then('New User Format D should be successfully Generated from Responder side as per admin case eight', async function () {
...
Given('New user navigates to the application and logs in as an admin as per Admin Case eight', async function () {
...
Given('New user adds a staff user and assigns rights to the new user as per Admin Case eight', { timeout: 120 * 1000 }, async function () {

    await manage_User.add_User(ad_data.AD_08.department, ad_data.AD_08.designation, ad_data.AD_08.sub_type);

    console.log(`Add User Name : ${ADDUSER_NAME}`);

    await manage_User.add_user_rights(ADDUSER_NAME, ad_data.AD_08.selectall, ad_data.AD_08.Home, ad_data.AD_08.Manage_User, ad_data.AD_08.FormatD, ad_data.AD_08.LOA_Generation, ad_data.AD_08.Award, ad_data.AD_08.Respond, ad_data.AD_08.LOA_Management)
...
Then('Assigned new user successfully logs in as a staff member of the new member as per Admin Case eight', async function () {
