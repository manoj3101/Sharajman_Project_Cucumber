...
Then('Admin rejects the new discom user as per Admin case fourteen', async function () {

    await manage_Member.click_Manage_Member(); //Manage Member
    await manage_Member.approve_Member(org_name, ad_data.AD_14.Manage_member);  //Member assitance
});
...
Given('New User verifying the registration status as per admin case fourteen', async function () {
