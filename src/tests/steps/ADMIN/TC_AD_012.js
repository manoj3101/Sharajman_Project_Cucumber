...
Then('Admin approves the payment and assigns rights to the new user as per Admin case tweleve', async function () {
    ...
    await manage_Member.member_rights(org_name, ad_data.AD_12.selectall, ad_data.AD_12.Home, ad_data.AD_12.Manage_User, ad_data.AD_12.FormatD, ad_data.AD_12.LOA_Generation, ad_data.AD_12.Award, ad_data.AD_12.Respond, ad_data.AD_12.LOA_Management);
