...
Then('Admin approves the payment and assigns rights to the new user as per Admin case six', async function () {
    ...
    await manage_Member.member_rights(org_name, ad_data.AD_06.selectall, ad_data.AD_06.Home, ad_data.AD_06.Manage_User, ad_data.AD_06.FormatD, ad_data.AD_06.LOA_Generation, ad_data.AD_06.Award, ad_data.AD_06.Respond, ad_data.AD_06.LOA_Management);
...
Given('User started creating Call for Proposal CFP as an initiator as per admin case six', async function () {
    ...
    await dashboardCFP.selectResponder(ad_data.AD_06.multiple_responder, org_name);
...
Given('New User started placing Response to the CFP as per admin case six', { timeout: 120 * 1000 }, async function () {
...
Then('New User Response CFP should be Placed successfully as per admin case six', async function () {
...
Given('User started generating the award and generating the LOA from initiator side as per admin case six', { timeout: 1200000 }, async function () {
...
Then('User Awarding and Generate LOA should be successfull as per admin case six', async function () {
...
Then('New User Responder Uploading the documents should be successfull as per admin case six', async function () {
...
//@                                                     Scenario 13
//-------------------------------------------------------------------------------------------------------------------------
Then('User Format D should be successfully Generated from initiator side as per admin case six', async function () {
...
Then('New User Format D should be successfully Generated from Responder side as per admin case six', async function () {
