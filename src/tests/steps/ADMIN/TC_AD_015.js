...
Then('Admin approves the new discom user and assigns a subscription plan as per Admin case fifteen', async function () {
    ...
    await manage_Member.approve_Member(org_name, ad_data.AD_15.Manage_member);  //Member assitance
...
Then('Admin approves the payment and assigns rights to the new user as per Admin case fifteen', async function () {
    ...
    await payment_Approval.paymentApproval(org_name, ad_data.AD_15.Payment_approval);
});
