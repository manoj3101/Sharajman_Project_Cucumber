...
//@                                                     Scenario 1
//-------------------------------------------------------------------------------------------------------------------------
Given('Admin navigate to the application and login and fetching the transaction fee formula as per import case six', async function () {
    console.log("------------------------------------------------------------------------------------------------------");
...
Given('User started creating Call for Proposal CFP as an initiator as per import case six', async function () {
    ...
    await dashboardCFP.selectResponder(data.TC_06.multiple_responder, data.responder);
...
Then('Call for Proposal CFP should be Published successfully as per import case six', async function () {
...
//@                                                     Scenario 2
//-------------------------------------------------------------------------------------------------------------------------
Given('User navigate to the Application and logged in as a discom user as Responder as per import case six', async function () {
...
Given('User started placing Response to the CFP as per import case six', { timeout: 120 * 1000 }, async function () {
...
Then('Response CFP should be Placed successfully as per import case six', async function () {
    ...
    await dashboardCFP.energycalculation_initiator(DashboardCFP.imp_start_date, DashboardCFP.imp_end_date, data.TC_06.imp_start_time, data.TC_06.imp_end_time, data.TC_06.minQuantumValue1);

    await dashboardCFP.energycalculation_responder(DashboardCFP.exp_start_date, DashboardCFP.exp_end_date, data.TC_06.exp_start_time, data.TC_06.exp_end_time, data.TC_06.ReturnValue1);
...
Given('User started generating the award and generating the LOA from initiator side as per import case six', { timeout: 1200000 }, async function () {
...
Then('Awarding and Generate LOA should be successfull as per import case six', async function () {
    ...
    await dashboardCFP.generateLOA(cfpNumber, DashboardCFP.imp_start_date, DashboardCFP.imp_end_date, data.TC_06.imp_start_time, data.TC_06.imp_end_time, data.TC_06.Quantum_value, DashboardCFP.exp_start_date, DashboardCFP.exp_end_date, data.TC_06.exp_start_time, data.TC_06.exp_end_time, data.TC_06.ReturnValue1, data.TC_06.Settlement_Price, data.TC_06.loa_issuance_mins);
...
Given('User started Uploading the documents from Responder Side as per import case six', async function () {
...
Then('Responder Uploading the documents should be successfull as per import case six', async function () {

    const cfpNumber = global.cfpNumber;
    console.log("Global CFP: " + cfpNumber);

    await loaManagement.uploadDocument(cfpNumber, DashboardCFP.imp_start_date, DashboardCFP.imp_end_date, data.TC_06.imp_start_time, data.TC_06.imp_end_time, data.TC_06.Quantum_value, DashboardCFP.exp_start_date, DashboardCFP.exp_end_date, data.TC_06.exp_start_time, data.TC_06.exp_end_time, data.TC_06.ReturnValue1, data.TC_06.Settlement_Price, data.TC_06.loa_acceptance_mins);
...
Then('Format D should be successfully Generated from initiator side as per import case six', async function () {
    ...
    await loaManagement.formatD(data.TC_06.GTAM, data.TC_06.source_of_generation, data.TC_06.RPO, data.TC_06.TGNA, DashboardCFP.imp_start_date, DashboardCFP.imp_end_date, data.TC_06.imp_start_time, data.TC_06.imp_end_time, data.TC_06.Quantum_value);
