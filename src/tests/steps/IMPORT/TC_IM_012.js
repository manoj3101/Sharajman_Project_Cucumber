...
//@                                                     Scenario 1
//-------------------------------------------------------------------------------------------------------------------------
Given('Admin navigate to the application and login and fetching the transaction fee formula as per import case twelve', async function () {
    console.log("------------------------------------------------------------------------------------------------------");
    console.log("                                            TC_IM_12                                                 ");
    console.log("------------------------------------------------------------------------------------------------------");
    ...
    await transactionFee.fetch_Transaction_Fee(data.feeName, data.TC_12.Quantum_value); // Fetch the transaction fee formula

    await transactionFee.fetch_Success_Fee(data.successfee, data.TC_12.Quantum_value); // Fetch the Success fee formula
...
Given('User started creating Call for Proposal CFP as an initiator as per import case twelve', async function () {
    ...
    await dashboardCFP.selectResponder(data.TC_12.multiple_responder, data.responder);
