...
Given('User started creating Call for Proposal CFP as an initiator as per export case Six', async function () {
    ...
    await dashboardCFP.selectResponder(data.EX_06.multiple_responder);
...
Then('Awarding and Generate LOA should be successfull as per export case Six', async function () {
    ...
    await dashboardCFP.generateLOA(cfpNumber, data.EX_06.imp_start_date, data.EX_06.imp_end_date, data.EX_06.imp_start_time, data.EX_06.imp_end_time, data.EX_06.Quantum_value, data.EX_06.exp_start_date, data.EX_06.exp_end_date, data.EX_06.exp_start_time, data.EX_06.exp_end_time, data.EX_06.ReturnValue1, data.EX_06.Settlement_Price);
...
Then('Responder Uploading the documents should be successfull as per export case Six', async function () {
    ...
    await loaManagement.uploadDocument(cfpNumber, data.EX_06.imp_start_date, data.EX_06.imp_end_date, data.EX_06.imp_start_time, data.EX_06.imp_end_time, data.EX_06.Quantum_value, data.EX_06.exp_start_date, data.EX_06.exp_end_date, data.EX_06.exp_start_time, data.EX_06.exp_end_time, data.EX_06.ReturnValue1, data.EX_06.Settlement_Price);
