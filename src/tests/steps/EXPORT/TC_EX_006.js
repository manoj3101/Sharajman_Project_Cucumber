...
Given('User started generating Format D from initiator side as per export case Six', async function () {
...
Then('Format D  should be successfully Generated as per export case Six', async function () {

    await loaManagement.formatD(data.EX_06.GTAM, data.EX_06.source_of_generation, data.EX_06.RPO, data.EX_06.TGNA);
