...
Given('User started creating Call for Proposal CFP as an initiator as per export case three', async function () {
    ...
    await dashboardCFP.selectResponder(data.EX_03.multiple_responder);
...
Then('Response CFP should be Placed successfully as per export case three', async function () {
    ...
    await dashboardCFP.energycalculation_initiator(data.EX_03.imp_start_date, data.EX_03.imp_end_date, data.EX_03.imp_start_time, data.EX_03.imp_end_time, data.EX_03.Quantum_value);

    await dashboardCFP.energycalculation_responder(data.EX_03.exp_start_date, data.EX_03.exp_end_date, data.EX_03.exp_start_time, data.EX_03.exp_end_time, data.EX_03.ReturnValue1);
...
Then('Responder two Response CFP should be Placed successfully as per export case three', async function () {
    ...
    await dashboardCFP.energycalculation_responder(data.EX_03.exp_start_date, data.EX_03.exp_end_date, data.EX_03.exp_start_time, data.EX_03.exp_end_time, data.EX_03.ReturnValue2);
...
Then('Responder three Response CFP should be Placed successfully as per export case three', async function () {
    ...
    await dashboardCFP.energycalculation_responder(data.EX_03.exp_start_date, data.EX_03.exp_end_date, data.EX_03.exp_start_time, data.EX_03.exp_end_time, data.EX_03.ReturnValue3);
...
Then('Awarding and Generate LOA should be successfull as per export case three', async function () {
    ...
    await dashboardCFP.generateLOA(cfpNumber, data.EX_03.imp_start_date, data.EX_03.imp_end_date, data.EX_03.imp_start_time, data.EX_03.imp_end_time, data.EX_03.Quantum_value, data.EX_03.exp_start_date, data.EX_03.exp_end_date, data.EX_03.exp_start_time, data.EX_03.exp_end_time, data.EX_03.ReturnValue1, data.EX_03.Settlement_Price);
...
Then('Responder Uploading the documents should be successfull as per export case three', async function () {
    ...
    await loaManagement.uploadDocument(cfpNumber, data.EX_03.imp_start_date, data.EX_03.imp_end_date, data.EX_03.imp_start_time, data.EX_03.imp_end_time, data.EX_03.Quantum_value, data.EX_03.exp_start_date, data.EX_03.exp_end_date, data.EX_03.exp_start_time, data.EX_03.exp_end_time, data.EX_03.ReturnValue1, data.EX_03.Settlement_Price);
...
Then('Format D should be successfully Generated from initiator side as per export case three', async function () {
    ...
    await loaManagement.formatD(data.EX_03.GTAM, data.EX_03.source_of_generation, data.EX_03.RPO, data.EX_03.TGNA, data.EX_03.imp_start_date, data.EX_03.imp_end_date, data.EX_03.imp_start_time, data.EX_03.imp_end_time, data.EX_03.Quantum_value);
