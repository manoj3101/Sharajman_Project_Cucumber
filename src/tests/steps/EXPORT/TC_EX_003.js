...
Then('Awarding and Generate LOA should be successfull as per export case three', async function () {
    ...
    await dashboardCFP.generateLOA(cfpNumber, data.EX_03.imp_start_date, data.EX_03.imp_end_date, data.EX_03.imp_start_time, data.EX_03.imp_end_time, data.EX_03.Quantum_value, data.EX_03.exp_start_date, data.EX_03.exp_end_date, data.EX_03.exp_start_time, data.EX_03.exp_end_time, data.EX_03.ReturnValue1, data.EX_03.Settlement_Price, data.EX_03.loa_issuance_mins);
...
Then('Responder Uploading the documents should be successfull as per export case three', async function () {
    ...
    await loaManagement.uploadDocument(cfpNumber, data.EX_03.imp_start_date, data.EX_03.imp_end_date, data.EX_03.imp_start_time, data.EX_03.imp_end_time, data.EX_03.Quantum_value, data.EX_03.exp_start_date, data.EX_03.exp_end_date, data.EX_03.exp_start_time, data.EX_03.exp_end_time, data.EX_03.ReturnValue1, data.EX_03.Settlement_Price, data.EX_03.loa_acceptance_mins);
